...
# Date    : Wednesday, November 29 09:54:48 CET 2017
# version : 0.0.0 
#
...
epics:
	...
	$(QUIET)echo "SEQ=$(M_SNCSEQ)"                     >> $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/RELEASE
	$(QUIET)echo "EPICS_BASE=$(COMMUNITY_EPICS_BASE)"  >> $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/RELEASE
	$(QUIET)echo "INSTALL_LOCATION=$(M_IP)"             > $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/CONFIG_SITE	
